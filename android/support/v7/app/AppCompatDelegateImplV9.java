...
class AppCompatDelegateImplV9 extends AppCompatDelegateImplBase implements Callback, Factory2 {
    ...
    class C02552 implements OnApplyWindowInsetsListener {
        C02552() {
        }
    ...
    class C02563 implements OnFitSystemWindowsListener {
        C02563() {
        }
    ...
    class C02574 implements OnAttachListener {
        C02574() {
        }
    ...
    class C02776 extends ViewPropertyAnimatorListenerAdapter {
        C02776() {
        }
        ...
        if (a.hasValue(C0156R.styleable.AppCompatTheme_windowActionBar)) {
            ...
            if (this.mWindowNoTitle) {
                ...
                if (VERSION.SDK_INT >= 21) {
                    ViewCompat.setOnApplyWindowInsetsListener(subDecor, new C02552());
                } else {
                    ((FitWindowsViewGroup) subDecor).setOnFitSystemWindowsListener(new C02563());
                }
            ...
            contentView.setAttachListener(new C02574());
            return subDecor;
        }
        a.recycle();
            ...
            if (this.mActionModeView != null) {
                ...
                if (callback.onCreateActionMode(mode, mode.getMenu())) {
                    ...
                    if (shouldAnimateActionModeView()) {
                        ...
                        this.mFadeAnim.setListener(new C02776());
                    } else {
