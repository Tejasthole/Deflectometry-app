...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new C02791();
    ...
    final ViewPropertyAnimatorListener mShowListener = new C02802();
    private boolean mShowingForMode;
    ScrollingTabContainerView mTabScrollView;
    private ArrayList<TabImpl> mTabs = new ArrayList();
    private Context mThemedContext;
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new C02603();

    class C02603 implements ViewPropertyAnimatorUpdateListener {
        C02603() {
        }
    ...
    class C02802 extends ViewPropertyAnimatorListenerAdapter {
        C02802() {
        }
