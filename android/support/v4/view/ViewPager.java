...
public class ViewPager extends ViewGroup {
    ...
    class C02444 implements OnApplyWindowInsetsListener {
        private final Rect mTempRect = new Rect();
    ...
    public static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C02451());
        Parcelable adapterState;
        ClassLoader loader;
        int position;

        static class C02451 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C02451() {
            }
    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C02444());
    }
