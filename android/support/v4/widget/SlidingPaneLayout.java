...
public class SlidingPaneLayout extends ViewGroup {
    ...
    static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C02531());
        boolean isOpen;

        static class C02531 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C02531() {
            }
