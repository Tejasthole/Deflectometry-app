...
class BitmapHunter implements Runnable {
    ...
    private static final RequestHandler ERRORING_HANDLER = new C02722();
    private static final ThreadLocal<StringBuilder> NAME_BUILDER = new C01931();
    ...
    static class C01931 extends ThreadLocal<StringBuilder> {
        C01931() {
        }
    ...
    static class C02722 extends RequestHandler {
        C02722() {
        }
